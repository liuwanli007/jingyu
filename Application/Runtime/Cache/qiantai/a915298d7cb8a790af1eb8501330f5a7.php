...
<body>
    <div data-role="page" style="background-image: url(/shixun/Public/qiantai/images/2.png);background-repeat: no-repeat;background-size:100% 100%">
        <a  rel="external" href="杨豪辉.html" class="ui-btn ui-icon-carat-l ui-btn-icon-left ui-nodisc-icon ui-btn-icon-notext" style="background-image: url(/shixun/Public/qiantai/images/2.png);border:0px">白色</a>
        <div class="lg-container">
            ...
            <form  id="lg-form" name="lg-form" method="post">
                ...
                <div data-role="controlgroup" data-type="horizontal">
                    <a rel="external" href="杨豪辉.html" data-role="button">登录</a>
                    <a rel="external" href="注册.html" data-role="button">注册</a>
                </div>
