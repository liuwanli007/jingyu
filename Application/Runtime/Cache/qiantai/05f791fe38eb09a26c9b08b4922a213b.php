    ...
    <div data-role="page" id="page6">
        ...
        <div data-role="header"  style="background-image: url(/shixun/Public/qiantai/images/2.png)" data-position="fixed">
            ...
            <div data-role="controlgroup" data-type="horizontal" style="text-align:center">
                <a href="<?php echo U('qiantai/dz/index');?>" rel="external"  onclick="JavaScript:history.back(-1);" data-role="button" >奇葩圈</a>
            ...
            <div data-role="navbar" class="navbar" >
                <ul class="ul2">
                    <li><a href="<?php echo U('qiantai/dz/index6');?>" rel="external" >大家玩</a></li>
                    <li><a href="<?php echo U('qiantai/dz/index7');?>" rel="external" >关注</a></li>
                    <li><a href="<?php echo U('qiantai/dz/index8');?>" rel="external" class="ui-btn-active">我的动态</a></li>
                </ul>
            </div>
        </div>
