...
<body>
 <div data-role="page" id="page2">
        <!--侧边栏-->
        <div data-role="panel" id="myPane2" data-display="overlay" style="width:200px;background-image: url('/shixun/Public/qiantai/images/2.png');background-size: 100% 150px;background-repeat: no-repeat" >
            <div >
        ...
        <div data-role="header"  style="background-image: url(/shixun/Public/qiantai/images/2.png)" data-position="fixed">
            <a href="#myPane2" class="ui-nodisc-icon" data-icon="img1" data-iconpos="notext" style="margin-top:6px"></a>
            ...
            <div data-role="navbar" class="navbar" >
                <ul class="ul2">
                    ...
                    <li><a href="#page2" class="ui-btn-active">段子</a></li>
